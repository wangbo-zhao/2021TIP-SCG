...
# IoU >= this threshold)
# origin _C.MODEL.ROI_HEADS.NMS = 0.7
_C.MODEL.ROI_HEADS.NMS = 0.7
# Maximum number of detections to return per image (100 is based on the limit
# established for the COCO dataset)
_C.MODEL.ROI_HEADS.DETECTIONS_PER_IMG = 20
...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 2  #TODO
...
_C.MODEL.RETINANET.NUM_CLASSES = 2 #TODO
